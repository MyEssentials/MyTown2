...
public class CmdClaimFar extends CommandBase {
	...
	public void process(ICommandSender sender, String[] args) throws Exception {
		...
		if (checkNearby(player.dimension, player.chunkCoordX, player.chunkCoordZ, town)) throw new CommandException(LocalizationProxy.getLocalization().getLocalization("mytown.cmd.err.claim.notFarClaim"));
