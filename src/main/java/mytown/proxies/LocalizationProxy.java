    ...
    public static Localization getLocalization() {
        ...
        if(localization == null) {
            try {
                ...
                if (is == null) {
                    is = LocalizationProxy.class.getResourceAsStream("/mytown/localization/" + Config.localization + ".lang");
                }
                if (is == null) {
                    is = LocalizationProxy.class.getResourceAsStream("/mytown/localization/en_US.lang");
